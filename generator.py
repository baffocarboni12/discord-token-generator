...
try:
    ...
    import colorama
    import cursor
    from pyscolor import Fore
    from capmonster_python import HCaptchaTask
except:
    os.system('pip install -q capmonster-python websocket requests colorama cursor pyscolor')
    import requests
    import colorama
    import cursor
    from pyscolor import Fore
...
class Booster:
    ...
    def __email__(self) -> str:
        ...
        email =  "ggn" + "_" + "".join(random.choices("abcdefghijklmnopqrstuvwxyz", k=8)) + random.choice(domains)
        return email
